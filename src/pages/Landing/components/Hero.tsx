      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid gap-12 lg:gap-8 items-center justify-center">
          ...
          >
            ...
            <h1 className="text-5xl text-center xl:text-[3.25rem] font-extrabold tracking-tight text-foreground mb-6 leading-[1.1]">
            ...
            <p className="text-center text-lg text-muted-foreground mb-8 leading-relaxed max-w-5xl">
            ...
            <div className="flex justify-center flex-col sm:flex-row gap-24">
              <button 
                onClick={() => navigate(ROUTES.login)}
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-orange-600 hover:from-primary hover:to-primary text-white px-8 py-2 rounded-xl font-semibold text-lg shadow-xl shadow-primary/25 hover:shadow-primary/40 transition-all hover:-translate-y-1"
              >
                Create Proposal <ArrowRight size={20} />
              </button>
              
              <button className="flex items-center justify-center gap-2 bg-card hover:bg-muted border border-border text-foreground px-8 py-2 rounded-xl font-semibold text-lg shadow-sm transition-all hover:-translate-y-1">
